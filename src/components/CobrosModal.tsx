...
export default function CobrosModal({ isOpen, onClose, invoices, total, loading }: Props) {
  ...
  const modal = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      ...
      <div className="relative w-full max-w-3xl bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl border border-white/20 dark:border-zinc-800 flex flex-col max-h-[85vh]">
        {/* Header */}
        ...
        <div className="overflow-auto flex-1">
          {loading ? (
            ...
            <table className="w-full text-sm">
              <thead className="sticky top-0 z-10 bg-zinc-50 dark:bg-zinc-800/80">
                <tr>
